...
To address this, this tool was developed to centralize inventory management, allowing authorized users to:

* Add new device records
* Update existing inventory entries
* Track equipment status (e.g., in use, available, borrowed)
...
* Structured data handling using Pandas DataFrames
...
* Time-consuming daily inventory counts
* Difficulty tracking borrowed or assigned devices
* Data inconsistencies across spreadsheets
* Limited centralized access for staff

To solve this, the application was designed and implemented as an internal tool requested by the office administration. It enabled all team members to:

* Log device usage and status changes
* Maintain a shared and updated inventory system
